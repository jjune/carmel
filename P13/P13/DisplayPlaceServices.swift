...
class DisplayPlaceServices: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        print(getServiceNameDescription(1, service_identifier: availableServices[indexPath.row].identifier))
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject!) {
        ...
        if segue.identifier == "DisplayWebsiteRedirector"  {
            ...
            if let indexPath = self.tableView.indexPathForSelectedRow?.row {
                destinationController.service_id = availableServices[indexPath].service_id
            }
    ...
    func getServiceNameDescription(service_id: Int, service_identifier: String) -> String {
